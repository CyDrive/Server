...
type SendFileInfoRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SendFileInfoRequest) Reset() {
	*x = SendFileInfoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_file_stream_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SendFileInfoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendFileInfoRequest) ProtoMessage() {}

func (x *SendFileInfoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_file_stream_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendFileInfoRequest.ProtoReflect.Descriptor instead.
func (*SendFileInfoRequest) Descriptor() ([]byte, []int) {
	return file_rpc_file_stream_proto_rawDescGZIP(), []int{4}
}

func (x *SendFileInfoRequest) GetFileInfo() *models.FileInfo {
	if x != nil {
		return x.FileInfo
	}
	return nil
...
func (x *SendFileInfoResponse) Reset() {
	*x = SendFileInfoResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_file_stream_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendFileInfoResponse) Descriptor() ([]byte, []int) {
	return file_rpc_file_stream_proto_rawDescGZIP(), []int{5}
}
...
var file_rpc_file_stream_proto_rawDesc = []byte{
	...
	,
	...
	0x6d, 0x2f, 0x43, 0x79, 0x44, 0x72, 0x69, 0x76, 0x65, 0x2f, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70,
...
var file_rpc_file_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_rpc_file_stream_proto_goTypes = []interface{}{
	...
	(*SendFileInfoRequest)(nil),   // 4: rpc.SendFileInfoRequest
	(*SendFileInfoResponse)(nil),  // 5: rpc.SendFileInfoResponse
	(*models.FileInfo)(nil),       // 6: models.FileInfo
}
var file_rpc_file_stream_proto_depIdxs = []int32{
	6, // 0: rpc.SendFileChunkRequest.file_info:type_name -> models.FileInfo
	6, // 1: rpc.SendFileInfoRequest.file_info:type_name -> models.FileInfo
	0, // 2: rpc.FileStream.SendFile:input_type -> rpc.SendFileChunkRequest
	2, // 3: rpc.FileStream.RecvFile:input_type -> rpc.RecvFileRequest
	4, // 4: rpc.FileStream.SendFileInfo:input_type -> rpc.SendFileInfoRequest
	1, // 5: rpc.FileStream.SendFile:output_type -> rpc.SendFileResponse
	3, // 6: rpc.FileStream.RecvFile:output_type -> rpc.RecvFileChunkResponse
	5, // 7: rpc.FileStream.SendFileInfo:output_type -> rpc.SendFileInfoResponse
...
func file_rpc_file_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_file_stream_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SendFileInfoRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_file_stream_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
